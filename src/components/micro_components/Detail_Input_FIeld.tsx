...
function Detail_Input_Field({
    ...
    return (
        <label
            htmlFor={id}
            className="flex flex-row justify-center items-center mb-1 detail_input_field_container"
        >
            <input
                type="text"
                id={id}
            ...
            <div className="relative h-10 flex flex-row justify-start items-center w-1/12 -translate-x-3 gap-4">
                ...
                <div
                    className="relative h-6 bg-black"
                    style={{ width: `${1}px`, backgroundColor: '#093652' }}
                ></div>
                <button
