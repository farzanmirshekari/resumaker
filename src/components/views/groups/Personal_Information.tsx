        ...
        <header className = 'flex flex-col w-full justify-center items-center'>
            <div className = 'flex flex-row text-center'>
                <div className = 'uppercase'>
                    <span className = 'flex flex-row full_name translate-y-3'><p>{full_name.split(' ')[0].padEnd(full_name.split(' ')[0].length + 1,' ')}</p>{Array(1).fill('\xa0').join('')}<p>{full_name.split(' ')[1]}</p></span>
                </div>
            </div>
